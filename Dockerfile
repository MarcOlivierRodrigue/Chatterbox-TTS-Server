...
RUN pip3 install --no-cache-dir --upgrade pip && \
    ...
    pip3 install --no-cache-dir --no-deps git+https://github.com/resemble-ai/chatterbox.git@5de7a54aa4e5e2baadb0182dde554908b48b85c2 s3tokenizer==0.3.0 onnx==1.16.0 && \
